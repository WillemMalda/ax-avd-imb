<#
.SYNOPSIS
    Azure Image Builder script to install Citrix Workspace LTSR using Winget.
...
Write-Host "*** AIB CUSTOMIZER PHASE: Installing Citrix Workspace LTSR ***"
...
$wingetAppId = "Citrix.Workspace.LTSR"
$wingetAppName = "Citrix Workspace LTSR"
